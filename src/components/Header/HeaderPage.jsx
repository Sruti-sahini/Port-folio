    ...
    return (
        <header className="site-header">
            ...
            <nav className="navbar">
                ...
                <a href="https://drive.google.com/file/d/1wxLdt8BJG-cVk3fDtB9Vhmz7UIR_teuu/view?usp=drive_link" target="_blank" offset={-150} duration={500} rel="noreferrer">
                    Resume
                </a>
            </nav>
