...
import imgabout from "../../img/Sruti.jpeg"
    ...
    <section className="about" id="about">
        ...
        <div className="row container">
            <div className="columns" data-aos="fade-right" data-aos-delay="300">
                <h4>
                I'm Sruti Sahini, a Competitive Programmer and a MERN Stack Developer.
                </h4>
                <p>
                I am Sahini Venkata Sitaram Sruti, a B.Tech student at IIT Patna and a former Applied Scientist Intern at Amazon, where I worked on machine learning projects. Proficient in C, C++, Python, React.js, Node.js, PyTorch, and TensorFlow, I also have experience in full-stack development. I am actively seeking full-time or internship opportunities in software development and data science to apply my skills and contribute to impactful projects.
                </p>
            ...
            <div className="columns col-skill" data-aos="fade-left" data-aos-delay="650">
                ...
                <div className="skill">
                    ...
                    {/* <div>
                        <img alt="SQL" className="icons-skils" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/java/java-original.svg" />
                        <h5>Java</h5>
                    </div> */}
                </div>
                <h4>Front-End</h4>
